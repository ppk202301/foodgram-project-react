    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(help_text='Could not be empty.', max_length=30, verbose_name='ingredient unit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.FloatField(default=0.001, help_text='Ingredient amount in the recipe (min 0.001).', validators=[django.core.validators.MinValueValidator(0.001, 'Min value should be more than 0.001.')], verbose_name='quantity')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(help_text='Show the final result.', upload_to='recipes/media', verbose_name='Recipe image')),
                ('about', models.TextField(blank=True, help_text='Describe your recipe.', max_length=250, verbose_name='Description')),
                ('production_time', models.PositiveIntegerField(default=5, help_text='Estimate approximate production time in minutes (min 5).', validators=[django.core.validators.MinValueValidator(5, 'Production time should be more than 5 min.')], verbose_name='Recipe production time')),
                ...
                ('ingredients', models.ManyToManyField(help_text='Add all components to your dish.', through='recipes.Ingredient_Recipe', to='recipes.ingredient', verbose_name='Recipe ingregiemts')),
            ],
            options={
                'verbose_name': 'Recipe',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(help_text='Point the user who added the tag to the recipe.', on_delete=django.db.models.deletion.CASCADE, related_name='author', to=settings.AUTH_USER_MODEL, verbose_name='Author')),
        ...
        migrations.AddField(
            model_name='recipe',
            name='tags',
            field=models.ManyToManyField(help_text='Add all tags to your recipe.', through='recipes.Recipe_Tag', to='recipes.tag', verbose_name='Recipe tags'),
        ),
        migrations.AddField(
